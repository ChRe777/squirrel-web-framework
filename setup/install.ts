...
/**
 * Give information after installation
 */
...
function doInstallation(props: any) {
    ...
    function cloneTemplate() {
        const repoUrl = `https://github.com/ChRe777/squirrel-${template}.git`;
        //const repoUrl = `https://github.com/squirrel/squirrel-${template}-template.git`;
